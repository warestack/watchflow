...
class TestPullRequestReviewEventHandler:
    ...
    @pytest.mark.asyncio
    async def test_handle_ignores_unsupported_actions(self, handler: PullRequestReviewEventHandler, mock_event: WebhookEvent) -> None:
    ...
    async def test_handle_enqueues_task(self, mock_task_queue: MagicMock, handler: PullRequestReviewEventHandler, mock_event: WebhookEvent) -> None:
    ...
    @pytest.mark.asyncio
    @patch("src.webhooks.handlers.pull_request_review.task_queue")
    async def test_handle_returns_ignored_for_duplicate(self, mock_task_queue: MagicMock, handler: PullRequestReviewEventHandler, mock_event: WebhookEvent) -> None:
